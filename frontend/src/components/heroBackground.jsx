...
const SmoothWavyCanvas = ({
  ...
  const animate = useCallback(() => {
    ...
    const primaryRgb = primaryColor.startsWith('#') ? hexToRgb(primaryColor) : primaryColor;
    const secondaryRgb = secondaryColor.startsWith('#') ? hexToRgb(secondaryColor) : secondaryColor;
    const accentRgb = accentColor.startsWith('#') ? hexToRgb(accentColor) : accentColor;
